...
#' @param threshold # the type of threshold to be used. The default "unique" will distribute genes into pattern with the lowest ranking. 
#' The "cut" option will threshold by the first gene to have a lower ranking, i.e. better fit to, a pattern. 
#' The "all" option will return a matrix of all of the genes in rank order for each pattern. 
...
#' @param full logical indicating whether to return the scores and ranks of each gene for each pattern
#'
...
patternMarkers <- function(
    ...
    threshold="unique", # the type of threshold to be used. The default "unique" will distribute genes into pattern with the lowest ranking. The "cut" option will threshold by the first gene to have a lower ranking, i.e. better fit to, a pattern. The "all" option will return a matrix of all of the genes in rank order for each pattern. 
